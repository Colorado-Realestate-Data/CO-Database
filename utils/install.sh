...
# setup project
NAME="coprop"
GITURL=https://github.com/Colorado-Realestate-Data/CO-Database.git
ROOTDIR=/opt/webapps
...
cp $DJANGODIR/coprop/coprop/settings/external_config_sample.py $PROJECTDIR/etc/external_config.py
